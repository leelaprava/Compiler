...
public class CodeGenVisitorTest implements ImageResources{
	...
	public void image_() throws Exception{
		String prog = "image1";
	...
	public void imageCopy() throws Exception{
		...
		String input = prog 
				...
				;
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {imageFile1}; //   {imageInURL}
		runCode(prog, bytecode, commandLineArgs);		
	
		BufferedImage loggedImage0 = RuntimeLog.globalImageLog.get(0);//1 - refImage0
		BufferedImage loggedImage1 = RuntimeLog.globalImageLog.get(1);//0  - output
		assertTrue(ImageSupport.compareImages(loggedImage0,loggedImage1));	//  ref , output
	...
	public void imageCopy1() throws Exception{
		...
		BufferedImage loggedImage0 = RuntimeLog.globalImageLog.get(1);//1 - refImage0
		BufferedImage loggedImage1 = RuntimeLog.globalImageLog.get(0);//0  - output
		assertTrue(ImageSupport.compareImages(loggedImage0,loggedImage1));	//  ref , output
